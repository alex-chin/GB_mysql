...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='События в календаре пользователя';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='События привязанные к локации и времени';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `media` VALUES (1,1,1,NULL,NULL,NULL,NULL,'2020-12-23 10:40:21',NULL);
...
INSERT INTO `media_types` VALUES (1,'photo forest','2020-12-23 10:11:48',NULL);
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tags` (
  `code` char(6) COLLATE utf8_unicode_ci NOT NULL COMMENT 'код тега, натуральный ключ',
  PRIMARY KEY (`code`),
  KEY `code` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Теги для быстрого поиска';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Теги на медиа для быстрого поиска';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'alex','chin',NULL,NULL,NULL);
...
-- Dump completed on 2020-12-24  8:44:33
